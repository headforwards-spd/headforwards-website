...
export default WordpressBlogPageTemplate;

WordpressBlogPageTemplate.propTypes = wordpressBlogTemplateProps;
WordpressBlogPageTemplate.defaultProps = {
    prev: null,
    next: null,
    categories: [],
    tags: [],
...
function WordpressBlogPageTemplate({ prev, next, html, author, categories, tags, date }) {
    return (
        <>
